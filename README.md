...
<pre> ## 📁 Dataset Structure ```text /dataset ├── images │ ├── train │ │ ├── image1.jpg │ │ ├── image2.jpg │ │ └── ... │ └── val │ ├── image101.jpg │ ├── image102.jpg │ └── ... ├── labels │ ├── train │ │ ├── image1.txt │ │ ├── image2.txt │ │ └── ... │ └── val │ ├── image101.txt │ ├── image102.txt │ └── ... └── data.yaml ``` </pre>
